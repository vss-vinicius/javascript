// Definindo uma variável 'país' e atribuindo o valor 'Brasil' a ela.
var país = 'Brasil'

// Exibindo uma mensagem no console que inclui o valor da variável 'país'.
console.log(`Vivendo em ${país}`)

// Iniciando uma estrutura condicional 'if' para verificar se a variável 'país' é igual a 'Brasil'.
if (país == 'Brasil') {
    // Se a condição for verdadeira, exibe uma mensagem indicando que a pessoa é brasileira.
